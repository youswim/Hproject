...
public class ExternalApiRequester {
    ...
    public List<RoadSpotInfo> requestRoadSpotInfos() throws IllegalStateException {
    ...
    public List<RoadInfoDto> requestRoadVolInfo(String rid, String date, Integer time) throws IllegalStateException {
