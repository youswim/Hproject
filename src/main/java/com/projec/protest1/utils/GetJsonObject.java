...
public class GetJsonObject {
    ...
    public List<RoadDto> formJsonToRoadDto(JSONObject jsonObject, String url) {
        JSONObject parsed_Obj = jsonObject.getJSONObject(url);
        //url에서 받아온 xml을 JSONObject로 변환하고 그 값을 parsed_Obj에 저장한다.
